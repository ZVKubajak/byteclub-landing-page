        ...
        >
          ...
          >
            ...
            <div className="grid sm:grid-cols-2 gap-4">
              {[
                { icon: Bell, title: "Launch Notifications", desc: "Be first in line when we officially launch" },
                { icon: Mail, title: "Weekly Updates", desc: "Stay informed about our progress" },
                { icon: Star, title: "Early Access", desc: "Get beta access before public release" },
                { icon: Shield, title: "Priority Support", desc: "Get help directly from our team" }
              ].map((benefit, index) => (
                <motion.div 
                  key={index}
                  initial={{ opacity: 0, y: 50 }}
